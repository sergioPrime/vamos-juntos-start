...
import { NFeManifestacaoDialog } from "./NFeManifestacaoDialog"
...
export default function NFeActionsMenu({
  ...
  const [manifestacaoDialogOpen, setManifestacaoDialogOpen] = useState(false)
  ...
  const handleManifestacao = () => {
    setManifestacaoDialogOpen(true)
  }
  ...
  return (
    <div>
      ...
      <NFeManifestacaoDialog
        open={manifestacaoDialogOpen}
        onOpenChange={setManifestacaoDialogOpen}
        nfeId={nfeId}
        nfeNumero={nfeNumero}
        onSuccess={onRefresh}
      />
