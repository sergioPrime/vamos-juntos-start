          ...
          {!statusData ? (
            ...
            <>
              <div className="space-y-3">
                ...
                {statusData.sefaz.data_autorizacao && (
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">Data Autorização:</span>
                    <span className="text-sm">
                      {new Date(statusData.sefaz.data_autorizacao).toLocaleString("pt-BR")}
                    </span>
                  </div>
                )}
              </div>
              ...
              {statusData.eventos && statusData.eventos.length > 0 && (
                <>
                  ...
                  <div className="space-y-2">
                    <h4 className="text-sm font-medium">Eventos Registrados:</h4>
