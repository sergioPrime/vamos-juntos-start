...
const cadastrosItems = [
  ...
  { title: "Depósitos", url: "/cadastros/depositos", icon: Package },
  ...
  { title: "Grupos Tributários", url: "/cadastros/tax-groups", icon: FileText },
  { title: "Operações Fiscais", url: "/cadastros/fiscal-operations", icon: Receipt },
