...
describe('usePermissionGuard', () => {
  ...
  it('deve retornar true quando usuário tem permissão', () => {
    ...
    const hasPermission = result.current.hasPermission('financeiro' as any, 'create');
  ...
  it('deve retornar false quando usuário não tem permissão', () => {
    ...
    const hasPermission = result.current.hasPermission('financeiro' as any, 'delete');
  ...
  it('deve verificar múltiplas permissões corretamente', () => {
    ...
    const hasCreatePermission = result.current.hasPermission('financeiro' as any, 'create');
    const hasDeletePermission = result.current.hasPermission('financeiro' as any, 'delete');
