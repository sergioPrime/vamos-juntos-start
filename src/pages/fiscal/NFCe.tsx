  ...
  const [nfceList] = useState<NFCe[]>([
    {
      ...
      valor_total: 150.00,
      status: "autorizada",
      chave_acesso: "35250112345678000165550010000000011234567890",
    },
    {
      id: "2",
      numero: "000002",
      ...
      valor_total: 230.50,
      status: "autorizada",
      chave_acesso: "35250112345678000165550010000000021234567891",
    },
  ]);
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Gerencie suas notas fiscais ao consumidor (Modelo 65)
            </p>
          </div>
          <Button
            ...
            <TableBody>
              {filteredNFCes.length === 0 ? (
                <TableRow>
                  ...
                  >
                    Nenhuma nota fiscal ao consumidor encontrada
                  </TableCell>
                </TableRow>
              ) : (
                  ...
                  <TableRow key={nfce.id}>
                    ...
                    <TableCell className="text-right">
                      <NFeActionsMenu
                        ...
                        onView={() => navigate(`/fiscal/nfce/${nfce.id}`)}
                      />
                    </TableCell>
                  </TableRow>
                ))
